...
```{r select-countries, warning=FALSE, message=FALSE}
...
```{r kable-extra, warning=FALSE, message=FALSE}
...
```{r graph-us, warning=FALSE, message=FALSE}
retail_wide_us %>%
  ggplot() +
...
```{r graph-brazil, warning=FALSE, message=FALSE}
retail_wide_brazil %>%
  ggplot() +
...
```{r graph-india, warning=FALSE, message=FALSE}
retail_wide_india %>%
  ggplot() +
...
```{r setupFlights, message=FALSE, warning=FALSE}
...
```{r flightspercapita, message=FALSE, warning=FALSE}
...
```{r impactdates, message=FALSE, warning=FALSE}
